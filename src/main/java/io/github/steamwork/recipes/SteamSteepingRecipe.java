...
/**
 * Recipe for the Steam Steeping Vat.
 * Converts raw materials like wood, plant fiber, resin, clay, kelp into processed materials.
 */
public record SteamSteepingRecipe(
    ...
    public static final RecipeType<SteamSteepingRecipe> RECIPE_TYPE =
            new RecipeType<>(steamworkKey("steam_steeping"));
    ...
    public @NotNull Gui display() {
        ItemStackBuilder clock = ItemStackBuilder.of(Material.CLOCK)
                .name(Component.translatable(
                        "steamwork.guide.recipe.steam_steeping",
        ...
        return Gui.builder()
                ...
                .addIngredient('m', ItemButton.of(SteamworkItems.STEAM_STEEPING_VAT))
