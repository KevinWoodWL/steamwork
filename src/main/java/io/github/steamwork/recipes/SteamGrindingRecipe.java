...
/**
 * 蒸汽研磨机配方。干法粉碎：把岩石、原矿、合金锭磨成粉。
 * 例：闪长岩 → 石英、铜锭 → 铜粉（Pylon 协同）。
 */
public record SteamGrindingRecipe(
    ...
    public static final RecipeType<SteamGrindingRecipe> RECIPE_TYPE =
            new RecipeType<>(steamworkKey("steam_grinding"));
    ...
    public @NotNull Gui display() {
        ItemStackBuilder clock = ItemStackBuilder.of(Material.CLOCK)
                .name(Component.translatable(
                        "steamwork.guide.recipe.steam_grinding",
        ...
        return Gui.builder()
                ...
                .addIngredient('m', ItemButton.of(SteamworkItems.STEAM_GRINDER))
