...
public record SteamPressurizingRecipe(
    ...
    public static final RecipeType<SteamPressurizingRecipe> RECIPE_TYPE =
            new RecipeType<>(steamworkKey("steam_pressurizing"));
    ...
    public @NotNull List<RecipeInput> getInputs() {
        ...
        inputs.add(RecipeInput.of(SteamworkFluids.STEAM, steamCost));
        return inputs;
    }
    ...
    public @NotNull Gui display() {
        ItemStackBuilder clock = ItemStackBuilder.of(Material.CLOCK)
                .name(Component.translatable(
                        "steamwork.guide.recipe.steam_pressurizing",
