...
public final class CrushingRecipes {
    ...
    public static void register() {
        ...
        SteamCrushingRecipe.RECIPE_TYPE.addRecipe(new SteamCrushingRecipe(
                ...
                RecipeInput.of(ItemStack.of(Material.OBSIDIAN)),
        ...
        SteamCrushingRecipe.RECIPE_TYPE.addRecipe(new SteamCrushingRecipe(
                ...
                RecipeInput.of(ItemStack.of(Material.MAGMA_BLOCK)),
                ItemStack.of(Material.MAGMA_CREAM, 2),
                35.0,
                180));
        ...
        SteamCrushingRecipe.RECIPE_TYPE.addRecipe(new SteamCrushingRecipe(
                ...
                RecipeInput.of(ItemStack.of(Material.DEEPSLATE_COAL_ORE)),
                ItemStack.of(Material.COAL, 2),
                50.0,
                240));
        ...
        SteamCrushingRecipe.RECIPE_TYPE.addRecipe(new SteamCrushingRecipe(
                ...
                RecipeInput.of(ItemStack.of(Material.DEEPSLATE_IRON_ORE)),
                ItemStack.of(Material.RAW_IRON, 2),
                60.0,
                280));
        ...
        SteamCrushingRecipe.RECIPE_TYPE.addRecipe(new SteamCrushingRecipe(
                ...
                RecipeInput.of(ItemStack.of(Material.DEEPSLATE_COPPER_ORE)),
                ItemStack.of(Material.RAW_COPPER, 6),
                55.0,
                260));
        ...
        SteamCrushingRecipe.RECIPE_TYPE.addRecipe(new SteamCrushingRecipe(
                ...
                RecipeInput.of(ItemStack.of(Material.DEEPSLATE_GOLD_ORE)),
                ItemStack.of(Material.RAW_GOLD, 2),
                65.0,
                280));
        ...
        SteamCrushingRecipe.RECIPE_TYPE.addRecipe(new SteamCrushingRecipe(
                ...
                RecipeInput.of(ItemStack.of(Material.DEEPSLATE_LAPIS_ORE)),
                ItemStack.of(Material.LAPIS_LAZULI, 8),
                55.0,
                260));
        ...
        SteamCrushingRecipe.RECIPE_TYPE.addRecipe(new SteamCrushingRecipe(
                ...
                ItemStack.of(Material.IRON_NUGGET, 3),
                25.0,
                160));
        ...
        SteamCrushingRecipe.RECIPE_TYPE.addRecipe(new SteamCrushingRecipe(
                ...
                RecipeInput.of(ItemStack.of(Material.COBBLESTONE)),
                ItemStack.of(Material.GRAVEL),
                15.0,
                100));
