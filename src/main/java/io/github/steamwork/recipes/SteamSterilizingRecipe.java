...
/**
 * Recipe for the Steam Sterilizer.
 * Converts raw/organic materials into clean/sterilized versions.
 */
public record SteamSterilizingRecipe(
    ...
    public static final RecipeType<SteamSterilizingRecipe> RECIPE_TYPE =
            new RecipeType<>(steamworkKey("steam_sterilizing"));
    ...
    public @NotNull Gui display() {
        ItemStackBuilder clock = ItemStackBuilder.of(Material.CLOCK)
                .name(Component.translatable(
                        "steamwork.guide.recipe.steam_sterilizing",
        ...
        return Gui.builder()
                ...
                .addIngredient('m', ItemButton.of(SteamworkItems.STEAM_STERILIZER))
